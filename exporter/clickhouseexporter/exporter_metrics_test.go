...
func simpleMetrics(count int) pmetric.Metrics {
	...
	for i := 0; i < count; i++ {
		...
		dp.Attributes().PutStr("session_id", "test_session_id")
		dp.Attributes().PutStr("installation_id", "test_installation_id")
		dp.Attributes().PutStr("app_id", "CaixabankNow")
		dp.Attributes().PutStr("app_environment", "PRE")
		dp.Attributes().PutStr("app_version", "1.0.0")
		dp.Attributes().PutStr("device_name", "Google Pixel")
		dp.Attributes().PutStr("device_platform", "Android")

		dp.Attributes().PutStr("device_os_version", "1.0")
		dp.Attributes().PutStr("carrier", "Vodafone")
		dp.Attributes().PutStr("network", "2G")
		dp.Attributes().PutStr("ip", "192.168.1.1")
		dp.Attributes().PutStr("user_id", "admin@obslyusers.com")
		dp.Attributes().PutStr("operation", "grant")
		dp.Attributes().PutStr("bf", "true")
		dp.Attributes().PutStr("type", "test")
		dp.Attributes().PutStr("status", "OK")
		dp.Attributes().PutStr("reason", "undefined")
		...
		dpHisto.Attributes().PutStr("session_id", "test_session_id")
		dpHisto.Attributes().PutStr("installation_id", "test_installation_id")
		dpHisto.Attributes().PutStr("app_id", "CaixabankNow")
		dpHisto.Attributes().PutStr("app_environment", "PRE")
		dpHisto.Attributes().PutStr("app_version", "1.0.0")
		dpHisto.Attributes().PutStr("device_name", "Google Pixel")
		dpHisto.Attributes().PutStr("device_platform", "Android")

		dpHisto.Attributes().PutStr("device_os_version", "1.0")
		dpHisto.Attributes().PutStr("carrier", "Vodafone")
		dpHisto.Attributes().PutStr("network", "2G")
		dpHisto.Attributes().PutStr("ip", "192.168.1.1")
		dpHisto.Attributes().PutStr("user_id", "admin@obslyusers.com")
		dpHisto.Attributes().PutStr("operation", "grant")
		dpHisto.Attributes().PutStr("bf", "true")
		dpHisto.Attributes().PutStr("type", "test")
		dpHisto.Attributes().PutStr("status", "OK")
		dpHisto.Attributes().PutStr("reason", "undefined")
		...
		dpExpHisto.Attributes().PutStr("session_id", "test_session_id")
		dpExpHisto.Attributes().PutStr("installation_id", "test_installation_id")
		dpExpHisto.Attributes().PutStr("app_id", "CaixabankNow")
		dpExpHisto.Attributes().PutStr("app_environment", "PRE")
		dpExpHisto.Attributes().PutStr("app_version", "1.0.0")
		dpExpHisto.Attributes().PutStr("device_name", "Google Pixel")
		dpExpHisto.Attributes().PutStr("device_platform", "Android")

		dpExpHisto.Attributes().PutStr("device_os_version", "1.0")
		dpExpHisto.Attributes().PutStr("carrier", "Vodafone")
		dpExpHisto.Attributes().PutStr("network", "2G")
		dpExpHisto.Attributes().PutStr("ip", "192.168.1.1")
		dpExpHisto.Attributes().PutStr("user_id", "admin@obslyusers.com")
		dpExpHisto.Attributes().PutStr("operation", "grant")
		dpExpHisto.Attributes().PutStr("bf", "true")
		dpExpHisto.Attributes().PutStr("type", "test")
		dpExpHisto.Attributes().PutStr("status", "OK")
		dpExpHisto.Attributes().PutStr("reason", "undefined")
		...
		summary.Attributes().PutStr("session_id", "test_session_id")
		summary.Attributes().PutStr("installation_id", "test_installation_id")
		summary.Attributes().PutStr("app_id", "CaixabankNow")
		summary.Attributes().PutStr("app_environment", "PRE")
		summary.Attributes().PutStr("app_version", "1.0.0")
		summary.Attributes().PutStr("device_name", "Google Pixel")
		summary.Attributes().PutStr("device_platform", "Android")

		summary.Attributes().PutStr("device_os_version", "1.0")
		summary.Attributes().PutStr("carrier", "Vodafone")
		summary.Attributes().PutStr("network", "2G")
		summary.Attributes().PutStr("ip", "192.168.1.1")
		summary.Attributes().PutStr("user_id", "admin@obslyusers.com")
		summary.Attributes().PutStr("operation", "grant")
		summary.Attributes().PutStr("bf", "true")
		summary.Attributes().PutStr("type", "test")
		summary.Attributes().PutStr("status", "OK")
		summary.Attributes().PutStr("reason", "undefined")
